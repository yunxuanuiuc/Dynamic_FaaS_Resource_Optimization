...
class optimizer():
    def __init__(self,
        ...
        #             self.model = vw
        #         else:
        self.model = vw.Workspace(f"--cb_explore {self.n_actions} --power_t 1 --decay_learning_rate 1 --epsilon 0.1",
                                  quiet=True, enable_logging=True)
...
def lambda_handler(event, context):
    ...
    model_config = event['Event']['config']
